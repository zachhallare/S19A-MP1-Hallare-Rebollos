...
/**
 * Represents a user account in the digital calendar. Each account has a
 * username, password, active status, and a list of owned calendars.
 */
public class Account {
    ...
    private final ArrayList<String> ownedCalendars;


    /**
     * Constructs a new Account with the given username and password. The
     * account is set to active by default and starts with no owned calendars.
    ...
    /**
     * Adds a calendar to the list of calendars owned by this account, if it is
     * not already present.
    ...
    /**
     * Removes a calendar from the list of calendars owned by this account.
