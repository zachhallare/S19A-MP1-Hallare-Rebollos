...
//         this.entriesPanel.setLayout(new BoxLayout(this.entriesPanel, BoxLayout.Y_AXIS));
//         redrawEntries(router);

//         JScrollPane scrollPane = new JScrollPane(this.entriesPanel);
...
//         addEntryButton.addActionListener(e -> router.showEntryForm(null));
...
//     // Redraw entries.
//     private void redrawEntries(Router router) {
//         entriesPanel.removeAll();

//         for (Entry entry : this.entries) {
//             JPanel entryTile = createEntryTile(router, entry);
...
//     // Create entry.
//     private JPanel createEntryTile(Router router, Entry entry) {
